...
//    },
    ...
    tbar: [
        ...
        {xtype: 'textfield', emptyText: 'Geometry name', reference: 'fieldName', bind:'{theGeometry.name}'},
        {xtype: 'checkboxfield', boxLabel: 'default dummy', reference: 'fieldDefault', bind:'{theGeometry.default_dummy}'}
    ],
